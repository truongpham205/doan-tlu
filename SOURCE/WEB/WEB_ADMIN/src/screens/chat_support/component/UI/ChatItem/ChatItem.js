...
export class ChatItem extends Component {
  render() {
    ...
    return (
      ...
      >
        <div className={classNames('rce-citem', this.props.isFocused && 'rce-citem-focused')}>
          <div
          ...
          <div className="rce-citem-body">
            <div className="rce-citem-body--top">
              <div className="rce-citem-body--top-title" style={{ marginBottom: -3 }}>
                {this.props.title}
              </div>
              <div className="rce-citem-body--top-time">
                {this.props.date && !isNaN(this.props.date) && (this.props.dateString || format(this.props.date))}
              </div>
            </div>
            ...
            <div className="rce-citem-body--bottom">
              <div className="rce-citem-body--bottom-title">
                ...
                {this.props.saleName && <p className="mb-0">Sale: {this.props.saleName}</p>}
              </div>
