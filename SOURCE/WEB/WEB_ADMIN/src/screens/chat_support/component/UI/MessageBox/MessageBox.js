...
export class MessageBox extends React.PureComponent {
  ...
  render() {
    ...
    var thatAbsoluteTime =
      !/(text|video|file|meeting)/g.test(this.props.type) && !(this.props.type === 'location' && this.props.text)

    const dateText = this.props.date && !isNaN(this.props.date) && (this.props.dateString || format(this.props.date))
    ...
    return (
      ...
      >
        {this.props.renderAddCmp instanceof Function && this.props.renderAddCmp()}
          ...
          >
            <div className="rce-mbox-body" onContextMenu={this.props.onContextMenu}>
              ...
              {(this.props.title || this.props.avatar) && (
                ...
                >
                  {this.props.avatar && <Avatar letterItem={this.props.letterItem} src={this.props.avatar} />}
              ...
              {this.props.type === 'text' && <div className="rce-mbox-text">{this.props.text}</div>}
              ...
              {this.props.type === 'photo' && (
                <PhotoMessage
                  onOpen={(currentPhoto) => this.props.onOpen(currentPhoto)}
              ...
              >
                ...
                {this.props.status && (
                  <span className="rce-mbox-status">
                    ...
                    {this.props.status === 'read' && <IoDoneAll color="#4FC3F7" />}
                  </span>
                )}
              </div>
            </div>
            ...
            {this.props.notch &&
              (this.props.position === 'right' ? (
                <svg
                  className={classNames('rce-mbox-right-notch', { 'message-focus': this.props.focus })}
                ...
                <div>
                  <svg
                    className={classNames('rce-mbox-left-notch', { 'message-focus': this.props.focus })}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                  >
                    <defs>
