...
import { LABEL_BUTTON_CLEAR_SEARCH, LABEL_BUTTON_SEARCH, NUMBER, ROUTER, STRING } from 'constants/Constant'
...
class SupplierListScreen extends Component {
  ...
  getData = async () => {
    const { search, province_id, district_id, provider_type_id, activePage } = this.state
    const payload = {
      search,
      province_id: province_id.value,
      district_id: district_id.value,
      provider_type_id: provider_type_id.value,
      page: activePage,
    }
  ...
  deleteProvider = async () => {
    ...
    try {
      await ProviderApi.deleteProvider({ listID: payload })
  ...
  renderField = () => {
    ...
    return (
      <Row className="mx-0 box--shadow p-3">
        <Col sm="12" md="6" lg="3" className="pl-0 responsive__inputField">
          <input
        ...
        <Col sm="12" md="6" lg="3" className="pl-0 responsive__inputField mb-2">
          <SelectField
        ...
        {/* <Col sm="12" md="6" className="pl-0 responsive__inputField">
          <SelectField
            ...
            selectedOption={wardOption}
            valueName={'wardOption'}
            onSelectChange={this.handleChange}
          />
        </Col> */}
        <Col sm="12" md="6" lg="3" className="pl-0 mb-2 responsive__inputField">
          <SelectField
            options={listProviderType}
            placeholder={STRING.supplierTypeName}
            selectedOption={provider_type_id}
            valueName={'provider_type_id'}
            onSelectChange={this.handleChangeSelect}
          />
        </Col>
...
export default withRouter(SupplierListScreen)
